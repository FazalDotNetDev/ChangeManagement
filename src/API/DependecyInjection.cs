...
namespace API
{
    public static class DependecyInjection
    {
        public static IServiceCollection AddDependecyInjection(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddApplicationServices(); // Use this layer to perform all the operations
            services.AddPersistenceServices().AddIdentityServices(); // These two services present here just for registration. You can not use them
